...
/**
* Specifies methods used to obtain and modify PersonType related information
* which is stored in the database.
*/
@Repository("basicsDB.PersonTypeDao")
public class PersonTypeDao extends WMGenericDaoImpl <PersonType, Integer> {
