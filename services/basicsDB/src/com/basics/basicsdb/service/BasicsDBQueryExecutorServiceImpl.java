...
@Service
public class BasicsDBQueryExecutorServiceImpl implements BasicsDBQueryExecutorService {
	private static final Logger LOGGER = LoggerFactory.getLogger(BasicsDBQueryExecutorServiceImpl.class);
